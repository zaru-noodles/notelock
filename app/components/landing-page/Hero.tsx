...
export default function Hero() {
  return (
    <section id="login" className="paper-bg w-full">
      <div className="relative xl:px-12 px-6 pt-18 pb-22 w-full max-w-7xl xl:w-[70%] mx-auto grid grid-cols-1 xl:grid-cols-[minmax(0,1.05fr)_minmax(0,420px)] gap-14 items-start xl:content-center justify-items-center xl:justify-items-start">
